...
You are given a pointer, root, pointing to the root of a binary search tree. Complete the levelOrder function provided in your editor so that it prints the level-order
...
class Solution:
    ...
    def levelOrder(self,root):
        ...
        while len(queue) != 0:
            ...
            treeElements = treeElements + str(currentNode.data) + " "
